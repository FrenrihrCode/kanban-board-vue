...
<template>
  ...
  >
    <div class="flex items-center justify-center w-6 h-6 bg-blue-500 rounded-full">
      <svg
        class="w-4 h-4 fill-current r-jwli3a r-4qtqp9 r-yyyyoo r-16y2uox r-1q142lx r-8kz0gk r-dnmrzs r-bnwqim r-1plcrui r-lrvibr r-1srniue"
        viewBox="0 0 24 24"
      >
        <g>
          <path
    ...
    <span class="ml-1 text-sm leading-none">@FrenrihrCode</span>
  </a>
</template>
